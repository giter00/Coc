...
'''
This is the work of other authors, and we use the SPOT in it to set the detection thresholds in our implementation. Author and certificate information has been removed to comply with double-blind regulations, we will add these information after the paper is accepted.
'''
